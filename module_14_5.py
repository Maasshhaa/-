...
# дальнейшие действия при нажатии кнопки регистрация
...
async def set_age(message, state):
    ...
    await message.answer(f"Регистрация прошла успешно! Были записаны следующие данные: Имя - {data['username']}, "
                         f"Email - {data['email']}, возраст - {data['age']}")
    await state.finish()
